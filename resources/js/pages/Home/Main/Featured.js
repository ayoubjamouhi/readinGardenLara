...
class Featured extends React.Component {
   render() {
      const article1 = <Col className="left" xs="12" sm="5" md="5" lg="5" xl="5">
         <a href={"articles/" + this.props.articles[this.props.articles.length - 1].slug}>
      ...
      const article_center = <Col className="center" xs="12" sm="4" md="4" lg="4" xl="4">
         <div>
            <div className="col-img">
               <a href={"articles/" + this.props.articles[this.props.articles.length - 2].slug}>
         ...
         <div>
            <div className="col-img">
               <a href={"articles/" + this.props.articles[this.props.articles.length - 3].slug}>
      ...
      const article_right = <Col className="right" xs="12" sm="3" md="3" lg="3" xl="3">
         <a href={"articles/" + this.props.articles[this.props.articles.length - 4].slug}>
